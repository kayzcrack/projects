...
CREATE TABLE Student(
	...
	CONSTRAINT fk_Student_Gender FOREIGN KEY(Sex) REFERENCES Gender(Sex), -- ON UPDATE CASCADE ON DELETE NO ACTION,
	CONSTRAINT fk_Student_Level FOREIGN KEY(LevelID) REFERENCES Level(LevelID), -- ON UPDATE CASCADE ON DELETE NO ACTION,
	CONSTRAINT fk_Student_Department FOREIGN KEY(DeptID) REFERENCES Department(DeptID) -- ON UPDATE CASCADE ON DELETE NO ACTION
	);
