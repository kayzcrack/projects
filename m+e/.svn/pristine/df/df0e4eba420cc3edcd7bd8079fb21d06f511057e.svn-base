...
<?php  
	...
	$url = "http://localhost/m+eWebService/addRespondent";
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          ...
          <td>description</td>
          <td>
            <input type="text" name="desc" id="textfield" tabindex="5" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>facility id</td>
          <td><input type="text" name="fid" id="textfield2" tabindex="10" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>human id</td>
          <td><input type="text" name="hid" id="textfield3" tabindex="15" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
