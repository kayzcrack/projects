...
<?php  
	...
	$url = "http://localhost/m+eWebService/addFacility";
		$post = "facilitytypeid=$ftid&contactid=$cid&statusid=$sid&servicetypeid=$stid&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Facility</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
...
$.post('http://localhost/m+eWebService/getCountries', function(data){
        ...
        <tr>
          ...
          <td><strong class="asterix">
            <input type="text" name="ftid" id="textfield" tabindex="10" />
            * </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>contact id</td>
          <td><input type="text" name="cid" id="textfield3" tabindex="12" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>status id</td>
          <td><input type="text" name="sid" id="textfield2" tabindex="15" />
            <strong class="asterix">*</strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="stid" id="textfield4" tabindex="20" />
            <strong class="asterix">*</strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
