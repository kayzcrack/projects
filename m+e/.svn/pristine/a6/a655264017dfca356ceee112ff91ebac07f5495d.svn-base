...
<?php  
	if(isset($_POST['submit'])){
		$adminpsw = trim($_POST['apsw']);
		$description = trim($_POST['desc']);
		$roleid = trim($_POST['roleid']);
		$adminUname = $_SESSION['full Name'];
		//$permission = $_SESSION['permission'];
		$url = "http://localhost/m+eWebService/createUserRole";
		$post = "roleid=$roleid&description=$description&adminUname=$adminUname&apwd=&adminpsw";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Create  User Role</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          <td width="16%">&nbsp;</td>
          <td>role id</td>
          <td><input type="text" name="roleid" id="textfield2" tabindex="10" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>description</td>
          <td><input type="text" name="desc" id="textfield3" tabindex="20" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="apsw" id="textfield5" tabindex="30" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
