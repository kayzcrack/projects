...
<?php  
	...
	$url = "http://localhost/m+eWebService/updateRespondent";
		$post = "description=$description&facilityid=$facilityId&humanid=$himanId&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Respondent</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          ...
          <td>description</td>
          <td>
            <input type="text" name="desc" id="textfield" tabindex="5" value="<?php echo $_GET['desc'];?>" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>facility id</td>
          <td><input type="text" name="fid" id="textfield2" tabindex="10" value="<?php echo $_GET['fid'];?>"  />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>human id</td>
          <td><input type="text" name="hid" id="textfield3" tabindex="15" value="<?php echo $_GET['hid'];?>" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
