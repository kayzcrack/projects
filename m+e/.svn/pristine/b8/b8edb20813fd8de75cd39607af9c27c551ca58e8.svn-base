...
<?php  
	...
	$url = "http://localhost/m+eWebService/addHumanRespondent";
...
$.post('http://localhost/m+eWebService/getCountries', function(data){
        ...
        <tr>
          <td>&nbsp;</td>
          <td>date of birth</td>
          <td><input type="text" name="dob" id="textfield3" tabindex="25" />
        ...
        <tr>
          ...
          <td>gender</td>
          <td><strong class="asterix">
            <select name="ccode2" id="ccode" tabindex="30">
...
$.post('http://localhost/m+eWebService/getCountries', function(data){
          ...
          <td><select name="ccode" id="show-list" tabindex="35">
