...
<?php  
	...
	$url = "http://localhost/m+eWebService/addTeam";
		$post = "teamid=$teamId&description=$description&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Team</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
