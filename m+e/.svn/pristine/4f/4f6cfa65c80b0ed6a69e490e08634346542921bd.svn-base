...
<?php  
	...
	$permissionId = $_POST['pid'];
	$roleId = $_POST['rid'];
	$username = $_SESSION["username"];
	$permission = $_SESSION["permission"];

	$url = "http://localhost/m+eWebService/addPermission";
		$post = "permissionid=$permissionId&roleid=$roleId&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          ...
          <td>permission id</td>
          <td>
            <input type="text" name="pid" id="textfield" tabindex="5" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>role id</td>
          <td><input type="text" name="rid" id="textfield2" tabindex="10" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
