...
<?php  
	...
	$adminusername = $_POST['auname'];
	$password = $_POST['apsw'];

	$url = "http://localhost/m+eWebService/activateUser";
		$post = "username=$username&adminusername=$adminusername&adminpassword=$password";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Activate User</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          ...
          <td><input type="text" name="auname" id="textfield2" tabindex="10" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><input type="password" name="apsw" id="textfield3" tabindex="15" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
