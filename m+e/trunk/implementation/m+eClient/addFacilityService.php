...
<?php  
	...
	$url = "http://localhost/m+eWebService/addFacilityService";
		$post = "serviceid=$serviceId&name=$name&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Facility Service</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
...
$.post('http://localhost/m+eWebService/getCountries', function(data){
        ...
        <tr>
          ...
          <td><strong class="asterix">
            <input type="text" name="sid" id="textfield" tabindex="10" />
            * </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
