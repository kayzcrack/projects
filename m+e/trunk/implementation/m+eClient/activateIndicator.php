...
<?php  
	...
	$iid = $_POST['indicatorId'];
	$username = $_POST['uname'];
	$permission = $_POST['permission'];

	$url = "http://localhost/m+eWebService/activateIndicator";
		$post = "indicatorid=$iid&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Activate Indicator</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          ...
          <td>indicator id</td>
          <td>
            <input type="text" name="indicatorId" id="textfield" tabindex="5" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>permission</td>
          <td><input type="text" name="permission" id="textfield3" tabindex="15" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
