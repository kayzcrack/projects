...
<?php  
	if(isset($_POST['submit'])){
		...
		$url = "http://localhost/m+eWebService/changeUserPassword";
		$post = "admin=$adminUname&apwd=$adminpsw&uname=$username&password=&password";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          ...
          <td><input type="text" name="apsw" id="textfield2" tabindex="10" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>username</td>
          <td><input type="text" name="uname" id="textfield3" tabindex="20" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>Password</td>
          <td><input type="text" name="psw" id="textfield5" tabindex="30" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
