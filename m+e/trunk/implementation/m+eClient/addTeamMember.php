...
<?php  
	...
	$url = "http://localhost/m+eWebService/addTeamMember";
		$post = "teamid=$teamId&uname=$uname&teamlead=$teamLead&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Team Member</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          <td width="16%">&nbsp;</td>
          <td width="17%">team id</td>
          <td width="39%">
            <input type="text" name="tid" id="textfield" tabindex="5" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>user name</td>
          <td><input type="text" name="uname" id="textfield2" tabindex="10" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>team lead</td>
          <td><input type="text" name="tlead" id="textfield3" tabindex="15" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
