...
<?php  
	...
	$url = "http://localhost/m+eWebService/addIndicator";
		$post = "id=$indicatorId&name=$name&statusid=$indicatorStatusId&indicatorclassid=$indicatorClassId&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Indicator</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
...
$.post('http://localhost/m+eWebService/getCountries', function(data){
          ...
          *</strong></td>
          <td width="35%">e.g. SP = student performance</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td> name</td>
        ...
        <tr>
          ...
          <td><strong class="asterix">
            <input type="text" name="isid" id="textfield6" tabindex="20" />
          *</strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="icid" id="textfield3" tabindex="25" />
