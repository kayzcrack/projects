...
<?php  
	...
	$respondentId = $_POST['rid'];
	$teamId = $_POST['tid'];
	$username = $_SESSION["username"];
	$permission = $_SESSION["permission"];

	$url = "http://localhost/m+eWebService/addTeamRespondent";
		$post = "respondentid=$respondentId&teamid=$teamId&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Team Respondent</h3>  
      <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
    ...
    <td><form id="form1" name="cuser" method="post" action="" onsubmit="return validateForm()">
      <table width="100%">
        ...
        <tr>
          ...
          <td>respondent id</td>
          <td>
            <input type="text" name="rid" id="textfield" tabindex="5" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td>team id</td>
          <td><input type="text" name="tid" id="textfield2" tabindex="10" />
            <strong class="asterix">* </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
