...
$.post('http://localhost/m+eWebService/getAllQuestions', function(data){
			var pushedData = jQuery.parseJSON(data);
			//document.write(data);
			var htmldata = "";
			htmldata = htmldata + '<tr><th>Question Id</th><th>Indicator Id</th><th>Question Status Id</th><th>Description</th><th>Instructions</th><th>Hint</th><th>Type Id</th><th>Action</th></tr>';
			$.each(pushedData.response, function(i, serverData){
			htmldata = htmldata  + '<tr><td>' + serverData.QuestionID + '</td><td> ' + serverData.IndicatorID +'</td><td>' + serverData.QuestionStatusID + '</td><td>' + serverData.Description + '</td><td>' + serverData.Instructions + '</td><td>' + serverData.Hint + '</td><td>' + serverData.TypeID + '</td><td><a href="logic/updateQuestions.php?iid='+ serverData.QuestionID +'&qid='+ serverData.IndicatorID +'&qsid='+ serverData.QuestionStatusID +'&desc='+ serverData.Description +'&instruction='+ serverData.Instructions +'&hint='+ serverData.Hint +'&tid='+ serverData.TypeID +'"><img src="images/editImage.jpg" width="15" height="15" alt="Update" /></a></td></tr>'; 						
				});
