...
<?php  
	...
	$continentCode = $_POST['ccode'];
	$name = $_POST['name'];	
	$username = $_SESSION["username"];
	$permission = $_SESSION["permission"];

	$url = "http://localhost/m+eWebService/addCountry";
		$post = "countrycode=$countryCode&name=$name&continentcode=$continentCode&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Country</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
...
$.post('http://localhost/m+eWebService/getCountries', function(data){
        ...
        <tr>
          ...
          <td><strong class="asterix">
            <input type="text" name="countryCode" id="textfield" tabindex="10" />
            * </strong></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>name</td>
          <td><input type="text" name="name" id="textfield3" tabindex="12" />
