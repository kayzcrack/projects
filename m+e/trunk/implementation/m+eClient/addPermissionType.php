...
<?php  
	...
	$url = "http://localhost/m+eWebService/addPermissionType";
		$post = "permissionid=$permissionId&description=$description&username=$username&permission=$permission";
			$handle = curl_init();
			curl_setopt_array(
			$handle,
			array(
...
?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logic/logout.php">sign out</a>
      ...
      <h3>Add Permission Type</h3>  <h6>Note: fields with * are required.</h6></div></td>
    </tr>
  <tr>
